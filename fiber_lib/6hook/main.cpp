...
void watch_io_read()
{
    banana::IOManager::GetThis()->addEvent(sock_listen_fd, banana::IOManager::READ, test_accept);
}
...
void test_accept()
{
    ...
    else
    {
        ...
        banana::IOManager::GetThis()->addEvent(fd, banana::IOManager::READ, [fd]()
        {
            char buffer[1024];
...
void test_iomanager()
{
    ...
    banana::IOManager iom(9);
    iom.addEvent(sock_listen_fd, banana::IOManager::READ, test_accept);
}
